				...
				<div class="card dash-widget">
					<div class="card-body">
						...
						<div class="dash-widget-info">
							<h3>{{App\Models\Lead::All()->Count()}}</h3>
							<span>Leads</span>
						</div>
					</div>
				</div>
			...
			<div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
				<div class="card dash-widget">
					<div class="card-body">
						...
						<div class="dash-widget-info">
							<h3>{{App\Models\User::All()->where('role','agent')->Count()}}</h3>
							<span>Agents</span>
						</div>
					</div>
				</div>
			...
			<div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
				<div class="card dash-widget">
					<div class="card-body">
						<span class="dash-widget-icon"><i class="fa fa-group"></i></span>
						<div class="dash-widget-info">
							<h3>{{App\Models\User::All()->where('role','team_leader')->Count()}}</h3>
				...
				<div class="card-group m-b-30">
					...
					<div class="card">
						<div class="card-body">
							...
							<p class="mb-0">Previous Month <span class="text-muted">$115,852</span></p>
						</div>
					</div>
