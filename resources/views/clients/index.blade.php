                                        ...
                                        <tr>
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="{{route('clients.show', $client)}}">{{$client->company->name}}</a>
                                                </h2>
                                            </td>
                                            <td>CLT-0001</td>
                                            <td>{{isset($client->primary_contact) ? $client->primary_contact->name : ''}}</td>
                                            <td>@if($client->emails->first() !==null){{ $client->emails->first()->address}} @endif</td>
                                            <td>@if($client->phones->first() !==null) {{$client->phones->first()->number}} @endif</td>
                                            <td>{{$client->status}}</td>
                                            <td class="text-right">
