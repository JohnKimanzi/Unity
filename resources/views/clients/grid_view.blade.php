                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto float-right ml-auto">
                            ...
                            <div class="view-icons">
                                <a href="{{route('clients-grid-view')}}" class="grid-view btn btn-link"><i class="fa fa-th"></i></a>
                                <a href="{{route('clients.index')}}" class="list-view btn btn-link active"><i class="fa fa-bars"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        @foreach ($clients as $client)
                            <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                                <div class="profile-widget">
                                    ...
                                    <h4 class="user-name m-t-10 mb-0 text-ellipsis"><a href="client-profile">{{$client->name}}</a></h4>
                                    <h5 class="user-name m-t-10 mb-0 text-ellipsis"><a href="client-profile">@if($client->primary_contact<>null) {{$client->primary_contact->name}} @endif </a></h5>
                                    <div class="small text-muted">@if($client->primary_contact<>null){{$client->primary_contact->name}} @endif </div>
                                    <a href="maito: {{$client->email}}" class="btn btn-white btn-sm m-t-10">Email</a>
                                    <a href="{{route('clients.show', $client)}}" class="btn btn-white btn-sm m-t-10">View Profile</a>
                                </div>
                            </div>
                        @endforeach
                    @endif
